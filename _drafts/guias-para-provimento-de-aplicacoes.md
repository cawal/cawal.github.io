...
- Crie um repositório GIT para o código;
	...
	- Proteja o *branch* master, de modo que não seja possível comitar direto a ele. Só permita que sejam realizadas pull requests e que todos os testes precisem ser executados antes do merge;  
